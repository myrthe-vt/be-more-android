...
├── wakeword.onnx              # OpenWakeWord model file (User Provided)
├── config.json                # User configuration
├── memory.json                # Auto-generated chat history
├── piper/                     # (Auto-generated by setup.sh - DO NOT COMMIT)
│   ├── piper                  # Executable binary
│   └── en_GB-semaine...onnx   # Default voice model
├── sounds/                    # Sound effects folder (User Provided)
│   ├── greeting_sounds/       # Folder for startup .wav files
│   ├── thinking_sounds/       # Folder for looping .wav files
│   ├── ack_sounds/            # Folder for "I heard you" .wav files
│   └── error_sounds/          # Folder for "Unknown command" .wav files
└── faces/                     # Face images folder (User Provided)
